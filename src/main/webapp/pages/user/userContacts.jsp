...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/userContacts.css" />
            ...
            <div class="col-md-12">
                <div class="profile_head">
                    <div class="profile_link">
                        ...
                        <a href="" class="username">${currentUser.userInfo.name} ${currentUser.userInfo.surname} (${currentUser.loginData.login})</a>
                    </div>
                    <div class="status_info">
                        Был менее 10 минут назад <br>
                        Зарегистрирован <fmt:parseDate value="${currentUser.userInfo.registrationTime}" var="datetime"
                    ...
                    <div class="head_links">
                        <div class="public_data">
                            <ul>
                                <li><a href="${pageContext.servletContext.contextPath}/user/${currentUser.loginData.login}">Профиль</a></li>
                            ...
                            <div class="private_item1">
                                <ul>
                                    ...
                                    <c:if test="${contactsNumber > 0}">
                                        <li><a href="${pageContext.servletContext.contextPath}/user/contacts" class="contacts active">Мои контакты (${contactsNumber})</a></li>
                                    </c:if>
                                </ul>
                            </div>
                ...
                <div class="head">
                    ...
                    <b>${currentUser.userInfo.name} ${currentUser.userInfo.surname} (${currentUser.loginData.login})</b>
                    <%--<span class="online">онлайн</span>--%>
                </div>
                <div class="contacts_list_wrap">
                    <b>Мои контакты</b>
                    <div class="contacts_list">
                        <c:if test="${not empty contacts}">
                            <c:forEach items="${contacts}" var="contact">
                                <div class="contact_item">
                                    <img src="${pageContext.request.contextPath}/resources/img/user-photo1.jpg" width="60" height="60" alt="">
                                    <div class="cn_info">
                                        <a href="${pageContext.servletContext.contextPath}/user/${contact.contact.loginData.login}" class="contact_link">${contact.contact.userInfo.name} ${contact.contact.userInfo.surname} (${contact.contact.loginData.login})</a>
                                        <a href="${pageContext.servletContext.contextPath}/user/${contact.contact.loginData.login}/message" class="msg">Отправить сообщение</a>
                                    </div>
                                    <script type="text/javascript">
                                        function setMarginMainContent() {
                                            var length = document.getElementsByClassName('contact_item').length;
                                            if(length > 3) {
                                                ...
                                                document.getElementById('main_content').setAttribute("style",
                                                        "margin-bottom:" + (150-length*30+15) + "px !important;");
                                            }
                                        }
                                    </script>
                                </div>
...
<footer>
    <div class="container">
        ...
        <div class="row ft_rights ">
            <div class="col-md-12">
                © 2012 ВК "Зоовет". Все права защищены.
            </div>
        </div>
    </div>
</footer>
